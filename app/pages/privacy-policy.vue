  ...
  <PageWrapper class="mx-auto flex max-w-(--container-4xl) flex-col">
    ...
    <div class="article">
      ...
      <p
        ...
        "
      >
        Θα θέλαμε να σας ενημερώσουμε ότι για το Junglershop η προστασία των προσωπικών δεδομένων των χρηστών μας έχει
      ...
      <p
        ...
        "
      >
        Για τη δημιουργία λογαριασμού στο shop.jungler.gr
      </p>
      <p
        class="
          text-primary-950
        ...
        "
      >
        Προσωπικά δεδομένα συλλέγονται όταν δημιουργείτε λογαριασμό στον ιστότοπο του Junglershop shop.jungler.gr. Κατά τη
      ...
      >
        ...
        διατηρούμε (Facebook/Instagram/Youtube κ.α.). Ειδικότερα, το Junglershop επεξεργάζεται προσωπικά δεδομένα
